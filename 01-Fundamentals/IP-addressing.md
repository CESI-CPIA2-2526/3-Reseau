...
IPv4 has served the internet well for decades, but its limited address space necessitates a transition to IPv6. While IPv4 will remain in use for years, IPv6 offers:
- Virtually unlimited addresses
- Simplified routing and configuration
- Built-in security features
- Better support for modern applications

Understanding both protocols is essential for network engineers, as the internet operates in a mixed IPv4/IPv6 environment.

---

## Review Questions

1. What is the total number of usable hosts in a /24 IPv4 network?
2. How many bits are in an IPv6 address?
3. What is the IPv6 equivalent of the IPv4 loopback address 127.0.0.1?
4. Why is NAT commonly used in IPv4 but not needed in IPv6?
5. What does SLAAC stand for and what is its purpose?
6. Convert the IPv4 address 192.168.1.1 to binary.
7. Shorten the following IPv6 address: 2001:0db8:0000:0000:0000:ff00:0042:8329
...
- **Subnetting Practice:** Use online calculators and subnet tables to master IPv4 subnetting
